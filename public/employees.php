...
<title><?= ucfirst('employees') ?> — NexaPOS</title>
...
<div class="content">
  <div class="page-header">
    <div>
      <h2 class="page-title"><?= ucfirst('employees') ?></h2>
  ...
  <div style="background:var(--white);border:1px solid var(--border);border-radius:var(--r-lg);padding:60px;text-align:center;color:var(--text3)">
    ...
    <div style="font-size:16px;font-weight:600;color:var(--text2);margin-bottom:8px"><?= ucfirst('employees') ?> module loading...</div>
