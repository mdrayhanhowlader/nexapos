...
<nav id="sidebar">
  ...
  <div class="sb-nav">
    ...
    <a href="<?= $_pub ?>/dashboard.php" class="sb-item<?= sbActive('dashboard', $currentPage) ?>">
      <svg class="sb-icon" viewBox="0 0 24 24"><path d="M3 13h8V3H3v10zm0 8h8v-6H3v6zm10 0h8V11h-8v10zm0-18v6h8V3h-8z"/></svg>
      Dashboard
    </a>
    <a href="<?= $_pub ?>/pos.php" class="sb-item<?= sbActive('pos', $currentPage) ?>">
    ...
    <a href="<?= $_pub ?>/products.php" class="sb-item<?= sbActive('products', $currentPage) ?>">
    ...
    <a href="<?= $_pub ?>/categories.php" class="sb-item<?= sbActive('categories', $currentPage) ?>">
    ...
    <a href="<?= $_pub ?>/orders.php" class="sb-item<?= sbActive('orders', $currentPage) ?>">
    ...
    <a href="<?= $_pub ?>/returns.php" class="sb-item<?= sbActive('returns', $currentPage) ?>">
      <svg class="sb-icon" viewBox="0 0 24 24"><path d="M12 5V1L7 6l5 5V7c3.31 0 6 2.69 6 6s-2.69 6-6 6-6-2.69-6-6H4c0 4.42 3.58 8 8 8s8-3.58 8-8-3.58-8-8-8z"/></svg>
      Returns
    </a>
    <a href="<?= $_pub ?>/customers.php" class="sb-item<?= sbActive('customers', $currentPage) ?>">
    ...
    <a href="<?= $_pub ?>/inventory.php" class="sb-item<?= sbActive('inventory', $currentPage) ?>">
      <svg class="sb-icon" viewBox="0 0 24 24"><path d="M20 2H4c-1.1 0-2 .9-2 2v18l4-4h14c1.1 0 2-.9 2-2V4c0-1.1-.9-2-2-2z"/></svg>
      Stock
    </a>
    <a href="<?= $_pub ?>/purchases.php" class="sb-item<?= sbActive('purchases', $currentPage) ?>">
    ...
    <a href="<?= $_pub ?>/suppliers.php" class="sb-item<?= sbActive('suppliers', $currentPage) ?>">
      <svg class="sb-icon" viewBox="0 0 24 24"><path d="M16 11c1.66 0 2.99-1.34 2.99-3S17.66 5 16 5c-1.66 0-3 1.34-3 3s1.34 3 3 3zm-8 0c1.66 0 2.99-1.34 2.99-3S9.66 5 8 5C6.34 5 5 6.34 5 8s1.34 3 3 3zm0 2c-2.33 0-7 1.17-7 3.5V19h14v-2.5c0-2.33-4.67-3.5-7-3.5zm8 0c-.29 0-.62.02-.97.05 1.16.84 1.97 1.97 1.97 3.45V19h6v-2.5c0-2.33-4.67-3.5-7-3.5z"/></svg>
      Suppliers
    </a>

    <div class="sb-section">Finance</div>
    <a href="<?= $_pub ?>/reports.php" class="sb-item<?= sbActive('reports', $currentPage) ?>">
    ...
    <a href="<?= $_pub ?>/expenses.php" class="sb-item<?= sbActive('expenses', $currentPage) ?>">
    ...
    <a href="<?= $_pub ?>/employees.php" class="sb-item<?= sbActive('employees', $currentPage) ?>">
    ...
    <a href="<?= $_pub ?>/settings.php" class="sb-item<?= sbActive('settings', $currentPage) ?>">
  ...
  <div class="sb-foot">
    <a href="<?= $_pub ?>/logout.php" class="sb-user">
